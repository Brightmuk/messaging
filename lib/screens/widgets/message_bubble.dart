...
class _MessageBubbleState extends State<MessageBubble> {
      ...
      children: [
        ...
        MediaQuery(
          data: MediaQuery.of(context).copyWith(
            textScaler: TextScaler.linear(widget.currentScale),
          ),
          child: Align(
                ...
                AnimatedContainer(
                  ...
                  margin: EdgeInsets.only(
                    ...
                    left: widget.isOutgoing
                        ? 50
                        : 12, // More space on the opposite side
                      ...
                      Text.rich(
                        TextSpan(
                          ...
                          children: [
                            ...
                            if (isMaskedMessage(maskedMessage) &&
                                widget.hide &&
                                MaskService.isMonitored(widget.message.address))
                              TextSpan(
  ...
  bool isMaskedMessage(String maskedMessage) {
